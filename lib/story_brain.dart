...
// ignore: prefer_final_fields
  ...
  String? getStoryTitle() {
    return _storyData[_a].storyTitle;
  }

  String? getChoice1() {
    return _storyData[_a].choice1;
  }

  String? getChoice2() {
    return _storyData[_a].choice2;
  }
  ...
  void nextStory(int choicenumber) {
    if (_a == 0 && choicenumber == 1)
      _a = 2;
    else if (_a == 2 && choicenumber == 1)
      _a = 5;
    else if (_a == 2 && choicenumber == 2)
      _a = 4;
    else if (_a == 1 && choicenumber == 1)
      _a = 2;
    else if (_a == 1 && choicenumber == 2)
      _a = 3;
    else if (_a == 3 ||
        _a == 4 ||
        _a == 5 && (choicenumber == 1 || choicenumber == 2)) restart();
  }
